...
func TestDeleteV4(t *testing.T) {
	deleteResp, err := messageService.DeleteV4(ctx, accessToken, &DeleteV4Request{
		Ids: []string{"c79670e6-8003-4520-8956-b14af62d89bb", "c79670e6-8003-4520-8956-b14af62d89bb"},
	})
